...
logo = Image.open("C:\\Users\\Habib\\Pictures\\picture\\white_dp.jpeg")
...
instructions = tk.Label(
    root, text="Select a file on your computer to extract all its text", font="Raleway")
instructions.grid(columnspan=3, column=0, row=1)


def open_file():
    browse_text.set("Loading...")
    file = askopenfile(parent=root, mode="rb", title="Choose a file", filetype=[
                       ("Pdf file", "*.pdf")])
    if file:
